...
class MaxxEqualizerPresetRepository(context: Context) {

    private val prefs = context.getSharedPreferences("maxx_equalizer_presets", Context.MODE_PRIVATE)
    ...
    fun savePreset(preset: MaxxPresetData) {
    ...
    fun loadPreset(name: String): MaxxPresetData? {
